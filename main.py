                    ...
                    MDBoxLayout:
                        ...
                        MDNavigationRail:
                            ...
                            MDNavigationRailItem:
                                text: "Эвакуация автомобилей"
                                icon: "language-Эвакуация автомобилей"

                            MDNavigationRailItem:
                                text: "Любой ремонт автомобилей"
                                icon: "language-Любой ремонт автомобилей"

                            MDNavigationRailItem:
                                text: "Магазин-склад автозапчастей"
                                icon: "language-cpp"

                            MDNavigationRailItem:
                                text: "Мойка автомобилей"
                                icon: "language-swift"
